...
from services.openrouter_images import OPENROUTER_FLUX_PAID_MODEL, OPENROUTER_FLUX_STACK_FALLBACKS


@pytest.mark.asyncio
async def test_flux_paid_uses_openrouter_with_internal_fallbacks() -> None:
