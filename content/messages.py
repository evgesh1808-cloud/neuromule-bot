...
def get_text_image_models(tariff) -> str:
    ...
    if tariff is TariffTier.FREE:
        return base_text + (
            "⚡ <b>Flux Schnell</b> — 1 фото в день бесплатно, далее — 3 💎\n"
...
TARIFF_PLANS = (
    ...
    "• ⚡ Flux Schnell — 1 фото в день бесплатно, далее — 3 💎\n"
...
TXT_FREE_IMAGE_MODEL_BLOCKED = (
    ...
    "<b>Flux Schnell</b>: <b>1</b> бесплатное фото в день, далее за кристаллы. "
    "Imagen 4 и другие модели — на тарифах MINI / SMART / ULTRA."
)
...
TXT_START_FIRST_MEET_NEED_CHANNEL_2 = (
    "• 🤖 ИИ-Ассистент: 1 ⚡️ за сообщение (30 ⚡️ обновляются ежедневно)\n"
    "• ⚡ Flux Schnell — <code>{photo_daily_limit}</code> фото в день бесплатно, далее — 3 💎\n\n"
...
TXT_START_PAYWALL = (
    ...
    "🎁 Ежедневно: 30 ⚡ Энергии на чат и 1 фото Flux Schnell в день бесплатно, далее — 3 💎!\n\n"
...
TXT_BLOGGER_COVER_INSUFFICIENT = (
    ...
    "На FREE — 1 фото Flux Schnell в день бесплатно, далее — 3 💎."
)
...
TXT_INSTRUCTION = (
    ...
    "🎨 Фото — на FREE: 1 фото Flux Schnell в день бесплатно, далее — 3 💎; на платных — Imagen, Flux и др. за 💎.\n"
...
TXT_TARIFFS_MAIN = (
    ...
    "«Стандарт»)</i>\n"
    "• 🖼️ 1 фото <b>Flux Schnell</b> в день бесплатно, далее — 3 💎\n"
