...
TXT_HD_UPGRADING_REPORT = (
    ...
    "Это бесплатно — ты уже оплатил полный разбор. Подожди ~1–2 минуты 🐎"
)
...
TXT_HD_UPGRADE_FAILED = (
    ...
    "или напиши /version — там должен быть <code>HD schema v2</code>."
)
...
TXT_HD_INSTAGRAM_ALBUM_CAPTION = (
    ...
    "в эстетичные неоновые карточки. Сохрани их на телефон, делись в Stories "
    "с друзьями и отмечай наш проект!"
)
