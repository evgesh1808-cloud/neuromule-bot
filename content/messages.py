...
IMAGE_MODELS: tuple[tuple[str, str], ...] = (
    ("🌠 Imagen 4 (FREE)", "imagen4"),
    ("🎨 Flux Schnell (PRO)", "flux-schnell"),
...
TXT_IMAGE_INTRO = (
    ...
    "🎨 Базовая генерация (Imagen 4) — БЕСПЛАТНО (3 раза в день)\n"
    "💎 PRO-фото (Flux Schnell) — 2 💎 за кадр\n"
    "• GPT Image 2 (DALL-E 3) — 2 💎\n"
    "• Gemini 3.1 Flash — Nano Banana 2 — 2 💎\n"
    "• Gemini 3 Pro — Nano Banana Pro — 2 💎\n\n"
...
TXT_TERMS_WELCOME = (
    "Привет! Добро пожаловать в NeuroMule 🚀\n\n"
    "Чтобы начать пользоваться текстовым ИИ, фотостудией и видео-пранками, "
    "пожалуйста, примите условия сервиса. Нажимая кнопку «Принять и начать», "
    "вы даёте согласие на обработку ваших данных и соглашаетесь с условиями "
    "публичной оферты."
)
TXT_TERMS_REQUIRED = (
    "Для работы с ботом необходимо принять условия сервиса. "
    "Ознакомьтесь с документами и нажмите «Принять и начать»."
)
TXT_TERMS_ACCEPT_BTN = "✅ Принять и начать"
...
TXT_CABINET_TEMPLATE = (
    ...
    "🎁 За первую покупку приглашённого друга — <b>+{referral_bonus} 💎</b> кристаллов на ваш баланс.\n\n"
