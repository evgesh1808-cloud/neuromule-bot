...
TARIFF_PLANS = (
    ...
    "• 🖼 DALL-E 3 — 1 качественное фото в день бесплатно, далее — 5 💎\n"
...
TXT_START_FIRST_MEET_NEED_CHANNEL_2 = (
    ...
    "• 🖼 DALL-E 3 — <code>{photo_daily_limit}</code> качественное фото в день бесплатно, далее — 5 💎\n\n"
...
TXT_START_PAYWALL = (
    ...
    "🎁 Ежедневно: 10 ⚡ Энергии на чат и 1 качественное фото DALL-E 3 в день бесплатно, далее — 5 💎!\n\n"
...
TXT_IMAGE_PICK_MODEL_FIRST = (
    "⚠️ Пожалуйста, сначала выберите модель (нажмите на кнопку «⚡ Flux Schnell» ниже), "
    "а затем отправьте описание!"
)
...
TXT_INSTRUCTION = (
    ...
    "🎨 Фото — на FREE: 1 качественное фото DALL-E 3 в день бесплатно, далее — 5 💎; на платных — Imagen, Flux и др. за 💎.\n"
...
TXT_TARIFFS_MAIN = (
    ...
    "«Стандарт»)</i>\n"
    "• 🖼️ 1 качественное фото <b>DALL-E 3</b> в день бесплатно, далее — 5 💎\n"
