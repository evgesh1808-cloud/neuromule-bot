...
_PAID_SUGGESTED_REPLIES_TAIL = (
    ...
    "и ровно 3 follow-up по якорям из ответа: максимум 3–5 слов и ≤34 символа каждый "
    "(пример: «Про сроки?», «Пример бюджета», «Риски запуска?»). "
    "Без длинных предложений. Не общие «подробнее/пример/дальше». "
