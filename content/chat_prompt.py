...
DENSE_LINE_BREAK_RULE = (
    ...
    "Категорически запрещено ставить более ОДНОГО переноса строки (\\n) между абзацами, заголовками и пунктами списков. "
    "Никогда не делай двойные или тройные пустые строки — текст должен быть плотным, аккуратным и легко читаться без лишнего скроллинга. "
    "Перед каждым значком эмодзи (💬, •, 💡) переноси строку ровно ОДИН раз."
)
...
ANSWER_GENERATION_RULES = (
    ...
    "6. ЗАЩИТА КОММЕРЧЕСКОЙ ТАЙНЫ И БРЕНДИНГ:\n"
...
_FREE_USER_COMPLIANCE_TAIL = (
    ...
    "Не более одного \\n между абзацами; перед 💬, •, 💡 — ровно один перенос строки. "
...
_PREMIUM_USER_COMPLIANCE_TAIL = (
    ...
    "Плотная верстка: не более одного \\n между блоками; перед 💬, •, 💡 — ровно один перенос строки. "
...
_ROLE_STANDARD = (
    ...
    "ответь, что эта информация в документе отсутствует. Если пользователь об этом не спрашивает, не пиши про отсутствие имен вовсе!\n"
...
4. ВЕРСТКА СТРУКТУРЫ И СПИСКОВ:
   ...
   4.4. Плотная верстка: не более ОДНОГО переноса строки (\\n) между абзацами, заголовками и пунктами списков. Двойные и тройные пустые строки запрещены.
   4.5. Перед каждым эмодзи 💬, •, 💡 — ровно один перенос строки (не два и не ноль).
