...
- Если прислана краткая тему/тезис: разверни её в глубокий нативный сторителлинг или b2b-кейс.
- Если прислана ссылка на новость, сырой текст инфоповода или скриншот статьи:
  ...
  4. В теле поста дай оценку ситуации: какие b2b-последствия это принесет рынку или аудитории.
...
[Вариант 3 (Хайп)]: {Провокационный заголовок, ломающий стереотипы}
