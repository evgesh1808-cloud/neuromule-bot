...
_PAID_STANDARD_COMPLIANCE_TAIL = (
    ...
    "В первом абзаце — живой отклик и слово «Маршрут». "
...
- Сохраняй фирменный экспертный коуч-стиль: теплый вводный абзац, слово 'Маршрут', нумерованные блоки с эмодзи и готовые реплики.
...
_PAID_STANDARD_ROLE_ADDON = (
    ...
    "Это классический премиальный Стандарт (не Chatcom). Отвечай как элитный коуч "
    ...
    "4. Без ультра-коротких 3–4 тезисов Chatcom. Блок ===КНОПКИ=== — только если "
