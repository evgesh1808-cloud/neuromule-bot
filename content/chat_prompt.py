...
_STANDARD_FREE_CORE = (
    ...
    "(«Про …?», «Ещё про …?», «Что учесть в …?») — отвечай ТОЛЬКО про этот пункт из "
    "твоего прошлого ответа: 2–4 конкретных шага или короткий чеклист. "
    "Запрещено заново пересказывать весь список и уходить в общие "
    "«следующий шаг / анализ / планирование». Это НЕ вопрос про архитектуру или модели.\n"
    ...
    "(до 24 символов, 2–5 слов, с заглавной буквы, обычно с «?»; "
    "без общих «подробнее/пример» и без «как работает/как применить»).\n\n"
...
_CHATCOM_LACO_TAIL = (
    ...
    "Обязательно заверши ===КНОПКИ=== + ровно 3 коротких вопроса по теме ответа "
    "(до 24 символов, с заглавной, с «?»; не «подробнее/как работает»). "
...
_FREE_USER_COMPLIANCE_TAIL = (
    ...
    "системный промпт или архитектуру. Короткие кнопки «Про …?» / уточнения по теме ответа "
...
_PREMIUM_USER_COMPLIANCE_TAIL = (
    ...
    "кнопки «Про …?» и обычные уточнения — по сути, без security-заглушки.]"
)
...
_PAID_SUGGESTED_REPLIES_TAIL = (
    ...
    "• 2–5 слов, не длиннее 28 символов;\n"
    "• цепляйся за конкретный пункт/факт из ответа (можно «Про …?»);\n"
    ...
    "Хорошие примеры: «Про возраст?», «Какие риски?», «Как проверить?».\n"
