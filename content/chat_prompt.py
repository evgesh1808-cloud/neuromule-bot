...
3. ДЛИНА: Развёрнутый экспертный текст приветствуется (ориентир 1200–2800 токенов). Всегда доводи мысль до логического конца — без обрыва на полуслове.
4. ЗАВЕРШЕНИЕ: Один точечный экспертный совет или уточняющий <b>💬 Вопрос: …?</b> — только по теме запроса, без рекламы.

⚠️ CRITICAL COMPLETION: Finish the full answer. Prefer structured depth over fluff; never cut mid-sentence or mid-list."""
