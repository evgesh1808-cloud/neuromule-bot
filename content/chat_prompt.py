...
Не пиши ничего кроме сценария с таймкодами и финального блока [SEO-КЛЮЧИ И ХЭШТЕГИ]."""
...
Пиши только готовую статью, без комментариев от себя."""
...
Пиши только готовый пост для VK."""
...
Пиши только готовый пост, уложись в лимит символов."""
