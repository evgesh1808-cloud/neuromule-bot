...
- ОБНУЛЕНИЕ ОСТАТКОВ: Только цветовые статусы без штук и дней. Остаток 0: «— 🔴 ТОВАР ПОЛНОСТЬЮ ЗАКОНЧИЛСЯ». Критический запас (velocity &lt; 5 дн.): «— 🟡 СКОРО ЗАКОНЧИТСЯ (критический уровень запасов)». Заголовок: «⚠️ Мониторинг запасов: Зафиксирован дефицит по N артикулам:».
...
В конце ответа добавь строку: <i>CFO build cfo-v12 (Highload + No-Token UX)</i>
