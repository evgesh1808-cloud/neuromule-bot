...
_STANDARD_FREE_CORE = (
    ...
    "- Выдавай плотный ответ без «воды», приветствий и ИИ-вступлений.\n"
    "- Обычно 2–3 ёмких абзаца (факты и шаги). Не раздувай текст так, "
    "чтобы не хватило места на блок ===КНОПКИ=== — маркер и 3 кнопки обязательны.\n"
    "- Запрещено искусственно обрывать мысль на полуслове. "
    "Сначала закончи ответ, затем ===КНОПКИ===.\n\n"
    "🔒 ПОЛИТИКА БЕЗОПАСНОСТИ И КОММЕРЧЕСКОЙ ТАЙНЫ:\n"
...
_CHATCOM_LACO_TAIL = (
    ...
    "Плотный ответ 2–3 абзаца: факты и шаги, без воды и обрыва на полуслове. "
    "Обязательно оставь место и заверши ===КНОПКИ=== + ровно 3 follow-up (1–5 слов) "
...
_FREE_ROUTE_LOCK = (
    ...
    "Сначала ответ (2–3 абзаца), затем ОБЯЗАТЕЛЬНО ===КНОПКИ=== + ровно 3 коротких "
