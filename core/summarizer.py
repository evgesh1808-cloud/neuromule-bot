...
1. НЕ выдумывай факты. Если в тексте чего-то нет, не добавляй это «от себя» для красоты.
...
2. Противопоказания и риски: в каких случаях описанные методы НЕ работают, опасны или требуют осторожности (критически важно для медицины, финансов, техники).
3. Важные условия: от каких сопутствующих факторов (образ жизни, подготовка, бюджет) зависит успех.
